...
var valListStyleImage = new CSS_Property.Val(function (v) {
    ...
    throw new Error("Failed pattern match at CSS.ListStyle.Image line 29, column 3 - line 30, column 3: " + [ v.constructor.name ]);
});
...
var genericListStyleImage = new Data_Generic.Generic(function (v) {
    ...
    throw new Error("Failed pattern match at CSS.ListStyle.Image line 23, column 1 - line 23, column 64: " + [ v.constructor.name ]);
});
...
var ordListStyleImage = new Data_Ord.Ord(function () {
    ...
    return function (y) {
        ...
        throw new Error("Failed pattern match at CSS.ListStyle.Image line 22, column 1 - line 22, column 56: " + [ x.constructor.name, y.constructor.name ]);
    };
});
module.exports = {
