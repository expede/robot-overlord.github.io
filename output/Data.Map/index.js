    ...
    return function (m) {
        var go = function ($copy_v) {
            ...
            function $tco_loop(v) {
                ...
                throw new Error("Failed pattern match at Data.Map line 428, column 21 - line 439, column 71: " + [ v.constructor.name ]);
            };
            while (!$tco_done) {
...
var showTree = function (dictShow) {
    return function (dictShow1) {
        return function (v) {
            ...
            throw new Error("Failed pattern match at Data.Map line 114, column 1 - line 115, column 1: " + [ v.constructor.name ]);
        };
    };
};
...
var mapWithKey = function (v) {
    return function (v1) {
        ...
        throw new Error("Failed pattern match at Data.Map line 482, column 1 - line 482, column 25: " + [ v.constructor.name, v1.constructor.name ]);
    };
};
var lookupLE = function (dictOrd) {
    return function (k) {
        ...
        var go = function (v) {
            ...
            throw new Error("Failed pattern match at Data.Map line 179, column 14 - line 192, column 36: " + [ v.constructor.name ]);
        };
        return go;
    };
};
var lookupGE = function (dictOrd) {
    return function (k) {
        ...
        var go = function (v) {
            ...
            throw new Error("Failed pattern match at Data.Map line 213, column 14 - line 226, column 37: " + [ v.constructor.name ]);
        };
        return go;
    };
};
...
var traversableMap = new Data_Traversable.Traversable(function () {
    ...
    return function (f) {
        return function (v) {
            ...
            throw new Error("Failed pattern match at Data.Map line 96, column 3 - line 96, column 30: " + [ f.constructor.name, v.constructor.name ]);
        };
    };
});
var findMin = function (v) {
    ...
    throw new Error("Failed pattern match at Data.Map line 253, column 1 - line 253, column 23: " + [ v.constructor.name ]);
};
var lookupGT = function (dictOrd) {
    return function (k) {
        ...
        var go = function (v) {
            ...
            throw new Error("Failed pattern match at Data.Map line 230, column 14 - line 243, column 37: " + [ v.constructor.name ]);
        };
        return go;
    };
};
var findMax = function (v) {
    ...
    throw new Error("Failed pattern match at Data.Map line 247, column 1 - line 247, column 23: " + [ v.constructor.name ]);
};
var lookupLT = function (dictOrd) {
    return function (k) {
        ...
        var go = function (v) {
            ...
            throw new Error("Failed pattern match at Data.Map line 196, column 14 - line 209, column 36: " + [ v.constructor.name ]);
        };
        return go;
    };
};
...
var checkValid = function (tree) {
    var allHeights = function (v) {
        ...
        throw new Error("Failed pattern match at Data.Map line 149, column 3 - line 149, column 30: " + [ v.constructor.name ]);
    };
