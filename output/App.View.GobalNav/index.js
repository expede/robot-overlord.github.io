...
//----------
var view = Text_Smolder_Markup["with"](Text_Smolder_Markup.attributableMarkupMF)(Text_Smolder_HTML.nav)(Text_Smolder_HTML_Attributes.id("global-nav"))(Control_Bind.discard(Control_Bind.discardUnit)(Text_Smolder_Markup.bindMarkupM)(navigate(Text_Smolder_Markup.eventableMarkupMF)(Text_Smolder_Markup.attributableMarkupMF)(Text_Smolder_Markup["with"](Text_Smolder_Markup.attributableMarkupMF)(Text_Smolder_HTML.a)(Text_Smolder_HTML_Attributes.className("training")))(new App_Routes.Training(App_Routes.TrainingHome.value))(Text_Smolder_Markup.text("Training")))(function () {
