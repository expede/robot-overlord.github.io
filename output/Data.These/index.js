...
var thisOrBoth = function (a) {
    return function (v) {
        ...
        throw new Error("Failed pattern match at Data.These line 108, column 1 - line 108, column 30: " + [ a.constructor.name, v.constructor.name ]);
    };
};
    ...
    return function (v1) {
        return function (v2) {
            return function (v3) {
                ...
                throw new Error("Failed pattern match at Data.These line 103, column 1 - line 103, column 27: " + [ v.constructor.name, v1.constructor.name, v2.constructor.name, v3.constructor.name ]);
            };
        };
    };
};
var thatOrBoth = function (b) {
    return function (v) {
        ...
        throw new Error("Failed pattern match at Data.These line 112, column 1 - line 112, column 30: " + [ b.constructor.name, v.constructor.name ]);
    };
};
var showThese = function (dictShow) {
    return function (dictShow1) {
        return new Data_Show.Show(function (v) {
            ...
            throw new Error("Failed pattern match at Data.These line 98, column 3 - line 99, column 3: " + [ v.constructor.name ]);
        });
    };
};
...
var functorThese = new Data_Functor.Functor(function (v) {
    return function (v1) {
        ...
        throw new Error("Failed pattern match at Data.These line 34, column 3 - line 34, column 34: " + [ v.constructor.name, v1.constructor.name ]);
    };
});
...
var fromThese = function (v) {
    return function (v1) {
        return function (v2) {
            ...
            throw new Error("Failed pattern match at Data.These line 116, column 1 - line 116, column 37: " + [ v.constructor.name, v1.constructor.name, v2.constructor.name ]);
        };
    };
};
...
var traversableThese = new Data_Traversable.Traversable(function () {
    ...
    return function (v) {
        ...
        throw new Error("Failed pattern match at Data.These line 50, column 3 - line 50, column 36: " + [ v.constructor.name ]);
    };
}, function (dictApplicative) {
    return function (v) {
        return function (v1) {
            ...
            throw new Error("Failed pattern match at Data.These line 47, column 3 - line 47, column 38: " + [ v.constructor.name, v1.constructor.name ]);
        };
    };
});
    ...
    return function (dictOrd1) {
        return new Data_Ord.Ord(function () {
            ...
            return function (y) {
                ...
                throw new Error("Failed pattern match at Data.These line 20, column 1 - line 20, column 62: " + [ x.constructor.name, y.constructor.name ]);
            };
        });
    };
};
var bifunctorThese = new Data_Bifunctor.Bifunctor(function (v) {
    return function (v1) {
        return function (v2) {
            ...
            throw new Error("Failed pattern match at Data.These line 55, column 3 - line 55, column 34: " + [ v.constructor.name, v1.constructor.name, v2.constructor.name ]);
        };
    };
});
    ...
    return function (v) {
        return function (v1) {
            return function (v2) {
                ...
                throw new Error("Failed pattern match at Data.These line 65, column 3 - line 65, column 41: " + [ v.constructor.name, v1.constructor.name, v2.constructor.name ]);
            };
        };
    };
});
var applyThese = function (dictSemigroup) {
    return new Control_Apply.Apply(function () {
        ...
        return function (v1) {
            ...
            throw new Error("Failed pattern match at Data.These line 71, column 3 - line 71, column 28: " + [ v.constructor.name, v1.constructor.name ]);
        };
    });
};
var bindThese = function (dictSemigroup) {
    return new Control_Bind.Bind(function () {
        ...
        return function (v1) {
            ...
            throw new Error("Failed pattern match at Data.These line 83, column 3 - line 83, column 27: " + [ v.constructor.name, v1.constructor.name ]);
        };
    });
};
