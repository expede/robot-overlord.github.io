...
//----------
var view = Text_Smolder_Markup["with"](Text_Smolder_Markup.attributableMarkupMF)(Text_Smolder_HTML.nav)(Text_Smolder_HTML_Attributes.id("global-nav"))(navigate(Text_Smolder_Markup.eventableMarkupMF)(Text_Smolder_Markup.attributableMarkupMF)(Text_Smolder_Markup["with"](Text_Smolder_Markup.attributableMarkupMF)(Text_Smolder_HTML.a)(Text_Smolder_HTML_Attributes.className("contact")))(App_Routes.Contact.value)(Text_Smolder_Markup.text("Contact Us")));
module.exports = {
    navigate: navigate, 
    view: view
};
