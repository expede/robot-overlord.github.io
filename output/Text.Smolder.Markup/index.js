...
var functorMarkupM = new Data_Functor.Functor(function (f) {
    return function (v) {
        ...
        throw new Error("Failed pattern match at Text.Smolder.Markup line 54, column 3 - line 54, column 88: " + [ f.constructor.name, v.constructor.name ]);
    };
});
...
var bindMarkupM = new Control_Bind.Bind(function () {
    ...
    return function (f) {
        ...
        throw new Error("Failed pattern match at Text.Smolder.Markup line 65, column 3 - line 65, column 90: " + [ v.constructor.name, f.constructor.name ]);
    };
});
