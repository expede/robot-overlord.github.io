...
var valTransformOriginOffset = new CSS_Property.Val(function (v) {
    ...
    throw new Error("Failed pattern match at CSS.Transform line 48, column 3 - line 48, column 35: " + [ v.constructor.name ]);
});
var valTransformOrigin = new CSS_Property.Val(function (v) {
    ...
    throw new Error("Failed pattern match at CSS.Transform line 56, column 3 - line 56, column 55: " + [ v.constructor.name ]);
});
