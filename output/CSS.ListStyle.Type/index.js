...
var valListStyleType = new CSS_Property.Val(function (v) {
    ...
    throw new Error("Failed pattern match at CSS.ListStyle.Type line 37, column 3 - line 38, column 3: " + [ v.constructor.name ]);
});
...
var genericListStyleType = new Data_Generic.Generic(function (v) {
    ...
    throw new Error("Failed pattern match at CSS.ListStyle.Type line 31, column 1 - line 31, column 62: " + [ v.constructor.name ]);
});
...
var ordListStyleType = new Data_Ord.Ord(function () {
    ...
    return function (y) {
        ...
        throw new Error("Failed pattern match at CSS.ListStyle.Type line 30, column 1 - line 30, column 54: " + [ x.constructor.name, y.constructor.name ]);
    };
});
var disc = Disc.value;
