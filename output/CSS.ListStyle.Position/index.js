...
var valListStylePosition = new CSS_Property.Val(function (v) {
    ...
    throw new Error("Failed pattern match at CSS.ListStyle.Position line 28, column 3 - line 29, column 3: " + [ v.constructor.name ]);
});
...
var genericListStylePosition = new Data_Generic.Generic(function (v) {
    ...
    throw new Error("Failed pattern match at CSS.ListStyle.Position line 22, column 1 - line 22, column 70: " + [ v.constructor.name ]);
});
...
var ordListStylePosition = new Data_Ord.Ord(function () {
    ...
    return function (y) {
        ...
        throw new Error("Failed pattern match at CSS.ListStyle.Position line 21, column 1 - line 21, column 62: " + [ x.constructor.name, y.constructor.name ]);
    };
});
module.exports = {
    Inside: Inside, 
