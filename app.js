...
var _robot_overlord$robot_overlord$Router_Route$Navigation = {ctor: 'Navigation'};
...
var _robot_overlord$robot_overlord$Model$Model = F2(
	function (a, b) {
		return {address: a, route: b};
	});
var _robot_overlord$robot_overlord$Model$init = function (_p0) {
	var _p1 = _p0;
	return {
		ctor: '_Tuple2',
		_0: A2(_robot_overlord$robot_overlord$Model$Model, _p1._1, _p1._0),
...
var _robot_overlord$robot_overlord$View_Style_Namespace$namespace = 'overlord';
var _robot_overlord$robot_overlord$View_Style_Namespace$_p0 = _rtfeldman$elm_css_helpers$Html_CssHelpers$withNamespace(_robot_overlord$robot_overlord$View_Style_Namespace$namespace);
var _robot_overlord$robot_overlord$View_Style_Namespace$id = _robot_overlord$robot_overlord$View_Style_Namespace$_p0.id;
var _robot_overlord$robot_overlord$View_Style_Namespace$class = _robot_overlord$robot_overlord$View_Style_Namespace$_p0.$class;
var _robot_overlord$robot_overlord$View_Style_Namespace$classList = _robot_overlord$robot_overlord$View_Style_Namespace$_p0.classList;

var _robot_overlord$robot_overlord$View_Style_Id$id = _robot_overlord$robot_overlord$View_Style_Namespace$id;
var _robot_overlord$robot_overlord$View_Style_Id$GlobalFooter = {ctor: 'GlobalFooter'};
var _robot_overlord$robot_overlord$View_Style_Id$GlobalHeader = {ctor: 'GlobalHeader'};
var _robot_overlord$robot_overlord$View_Style_Id$NavBar = {ctor: 'NavBar'};

var _robot_overlord$robot_overlord$View_Style_Color$white = A3(_elm_lang$core$Color$rgb, 255, 255, 255);
var _robot_overlord$robot_overlord$View_Style_Color$navy = A3(_elm_lang$core$Color$rgb, 34, 40, 50);
var _robot_overlord$robot_overlord$View_Style_Color$lightBlue = A3(_elm_lang$core$Color$rgb, 102, 216, 213);
var _robot_overlord$robot_overlord$View_Style_Color$pink = A3(_elm_lang$core$Color$rgb, 236, 112, 119);
var _robot_overlord$robot_overlord$View_Style_Color$accent = _robot_overlord$robot_overlord$View_Style_Color$pink;
var _robot_overlord$robot_overlord$View_Style_Color$highlight = _robot_overlord$robot_overlord$View_Style_Color$lightBlue;
var _robot_overlord$robot_overlord$View_Style_Color$base = _robot_overlord$robot_overlord$View_Style_Color$navy;
var _robot_overlord$robot_overlord$View_Style_Color$neutral = _robot_overlord$robot_overlord$View_Style_Color$white;

var _robot_overlord$robot_overlord$View_Style_Size$base = 14;

var _robot_overlord$robot_overlord$View_Component_Head$hamburger = A2(_jystic$elm_font_awesome$FontAwesome$bars, _robot_overlord$robot_overlord$View_Style_Color$base, _robot_overlord$robot_overlord$View_Style_Size$base);
var _robot_overlord$robot_overlord$View_Component_Head$head = A2(
...
var _robot_overlord$robot_overlord$View_Component_Foot$foot = A2(
	_elm_lang$html$Html$footer,
	_elm_lang$core$Native_List.fromArray(
		[
			_robot_overlord$robot_overlord$View_Style_Id$id(
			_elm_lang$core$Native_List.fromArray(
				[_robot_overlord$robot_overlord$View_Style_Id$GlobalFooter]))
		]),
	_elm_lang$core$Native_List.fromArray(
		[
			A2(
			...
			_elm_lang$core$Native_List.fromArray(
				[
					_elm_lang$html$Html$text('©2016 Robot Overlord Software Inc.')
				]))
		]));

var _robot_overlord$robot_overlord$View_Asset$logoPath = './media/logo.png';
var _robot_overlord$robot_overlord$View_Asset$logo = A2(
	_elm_lang$html$Html$img,
	_elm_lang$core$Native_List.fromArray(
		[
			_elm_lang$html$Html_Attributes$src(_robot_overlord$robot_overlord$View_Asset$logoPath)
		]),
	_elm_lang$core$Native_List.fromArray(
		[]));

var _robot_overlord$robot_overlord$View_Style_Class$classList = _robot_overlord$robot_overlord$View_Style_Namespace$classList;
var _robot_overlord$robot_overlord$View_Style_Class$class = _robot_overlord$robot_overlord$View_Style_Namespace$class;
var _robot_overlord$robot_overlord$View_Style_Class$TrueCenter = {ctor: 'TrueCenter'};
var _robot_overlord$robot_overlord$View_Style_Class$FillViewport = {ctor: 'FillViewport'};
var _robot_overlord$robot_overlord$View_Style_Class$FillPage = {ctor: 'FillPage'};
var _robot_overlord$robot_overlord$View_Style_Class$Logo = {ctor: 'Logo'};

var _robot_overlord$robot_overlord$View_Page_Home$homePage = A2(
	_elm_lang$html$Html$section,
	_elm_lang$core$Native_List.fromArray(
		[
			_robot_overlord$robot_overlord$View_Style_Class$class(
			_elm_lang$core$Native_List.fromArray(
				[_robot_overlord$robot_overlord$View_Style_Class$FillPage, _robot_overlord$robot_overlord$View_Style_Class$TrueCenter]))
		]),
	_elm_lang$core$Native_List.fromArray(
		[
			A2(
				...
				[
					...
					_elm_lang$core$Native_List.fromArray(
						[
							_robot_overlord$robot_overlord$View_Style_Class$class(
							_elm_lang$core$Native_List.fromArray(
								[_robot_overlord$robot_overlord$View_Style_Class$Logo]))
						]),
					_elm_lang$core$Native_List.fromArray(
						[_robot_overlord$robot_overlord$View_Asset$logo])),
					A2(
					...
					_elm_lang$core$Native_List.fromArray(
						[
							_elm_lang$html$Html$text('Robot Overlord')
						]))
				]))
		]));

var _robot_overlord$robot_overlord$View_Page_Navigation$link = F2(
				...
				[
					...
					_elm_lang$core$Native_List.fromArray(
						[
							...
							_robot_overlord$robot_overlord$Signal$NavigateTo(route))
						]),
					_elm_lang$core$Native_List.fromArray(
						[
...
var _robot_overlord$robot_overlord$View_Page_Navigation$siteNav = A2(
	_elm_lang$html$Html$nav,
	_elm_lang$core$Native_List.fromArray(
		[
			_robot_overlord$robot_overlord$View_Style_Class$class(
			_elm_lang$core$Native_List.fromArray(
				[_robot_overlord$robot_overlord$View_Style_Id$NavBar]))
		]),
	_elm_lang$core$Native_List.fromArray(
		[
			A2(
			...
			_elm_lang$core$Native_List.fromArray(
				[
					A2(_robot_overlord$robot_overlord$View_Page_Navigation$link, _robot_overlord$robot_overlord$Router_Route$Home, 'Home'),
					A2(_robot_overlord$robot_overlord$View_Page_Navigation$link, _robot_overlord$robot_overlord$Router_Route$Code, 'Code'),
					A2(_robot_overlord$robot_overlord$View_Page_Navigation$link, _robot_overlord$robot_overlord$Router_Route$Design, 'Design'),
					A2(_robot_overlord$robot_overlord$View_Page_Navigation$link, _robot_overlord$robot_overlord$Router_Route$About, 'About'),
					A2(_robot_overlord$robot_overlord$View_Page_Navigation$link, _robot_overlord$robot_overlord$Router_Route$Contact, 'Contact'),
					A2(_robot_overlord$robot_overlord$View_Page_Navigation$link, _robot_overlord$robot_overlord$Router_Route$Portfolio, 'Portfolio')
				]))
		]));
var _robot_overlord$robot_overlord$View_Page_Navigation$navigationPage = _robot_overlord$robot_overlord$View_Page_Navigation$siteNav;

var _robot_overlord$robot_overlord$View_Page_NotFound$notFoundPage = A2(
	_elm_lang$html$Html$section,
	_elm_lang$core$Native_List.fromArray(
		[]),
	_elm_lang$core$Native_List.fromArray(
...
var _robot_overlord$robot_overlord$View_Page_Design$designPage = A2(
	_elm_lang$html$Html$section,
	_elm_lang$core$Native_List.fromArray(
		[
			_robot_overlord$robot_overlord$View_Style_Class$class(
		...
		[
			...
			_elm_lang$core$Native_List.fromArray(
				[
					...
					_elm_lang$core$Native_List.fromArray(
						[
							_elm_lang$html$Html$text('Design:')
						])),
					A2(
					_elm_lang$html$Html$h2,
					_elm_lang$core$Native_List.fromArray(
					...
					_elm_lang$core$Native_List.fromArray(
						[
							_elm_lang$html$Html$text('Usability & Human/Computer Interaction')
						]))
				])),
			A2(
			_elm_lang$html$Html$section,
				...
				[
					...
					_elm_lang$core$Native_List.fromArray(
						[
							...
							_elm_lang$core$Native_List.fromArray(
								[
									_elm_lang$html$Html$text('Design is how it works'),
									A2(
									...
									_elm_lang$core$Native_List.fromArray(
										[])),
									_elm_lang$html$Html$text('~Steve Jobs')
								]))
						])),
					A2(
					_elm_lang$html$Html$p,
...
var _robot_overlord$robot_overlord$View_Page$page = function (route) {
	var _p0 = route;
	if (_p0.ctor === 'Home') {
		return _robot_overlord$robot_overlord$View_Page_Home$homePage;
	} else {
		return _robot_overlord$robot_overlord$View_Page_NotFound$notFoundPage;
	}
};

var _robot_overlord$robot_overlord$View$view = function (model) {
	return A2(
		_elm_lang$html$Html$section,
		_elm_lang$core$Native_List.fromArray(
			[
		...
		_elm_lang$core$Native_List.fromArray(
			[
				_robot_overlord$robot_overlord$View_Component_Head$head,
				_robot_overlord$robot_overlord$View_Page$page(model.route),
				_robot_overlord$robot_overlord$View_Component_Foot$foot
			]));
};
...
var _robot_overlord$robot_overlord$Router_Match$to = F2(
	function (route, fragment) {
		return A2(
			_evancz$url_parser$UrlParser$format,
			route,
			_evancz$url_parser$UrlParser$s(fragment));
	});
var _robot_overlord$robot_overlord$Router_Match$matchers = _evancz$url_parser$UrlParser$oneOf(
	_elm_lang$core$Native_List.fromArray(
		[
			A2(_robot_overlord$robot_overlord$Router_Match$to, _robot_overlord$robot_overlord$Router_Route$Home, ''),
			A2(_robot_overlord$robot_overlord$Router_Match$to, _robot_overlord$robot_overlord$Router_Route$Navigation, 'navigate'),
			A2(_robot_overlord$robot_overlord$Router_Match$to, _robot_overlord$robot_overlord$Router_Route$Code, 'code'),
			A2(_robot_overlord$robot_overlord$Router_Match$to, _robot_overlord$robot_overlord$Router_Route$Design, 'design'),
			A2(_robot_overlord$robot_overlord$Router_Match$to, _robot_overlord$robot_overlord$Router_Route$About, 'about'),
			A2(_robot_overlord$robot_overlord$Router_Match$to, _robot_overlord$robot_overlord$Router_Route$Contact, 'contact'),
			A2(_robot_overlord$robot_overlord$Router_Match$to, _robot_overlord$robot_overlord$Router_Route$Portfolio, 'portfolio')
		]));

var _robot_overlord$robot_overlord$Router$routerConfig = {hash: true, basePath: ''};
...
var _robot_overlord$robot_overlord$Main$main = {
	main: A2(
		...
		_robot_overlord$robot_overlord$Update$urlParser,
		{
			init: _robot_overlord$robot_overlord$Model$init,
			view: _robot_overlord$robot_overlord$View$view,
			update: _robot_overlord$robot_overlord$Update$update,
			urlUpdate: _robot_overlord$robot_overlord$Update$urlUpdate,
...
var Elm = {};
Elm['Main'] = Elm['Main'] || {};
_elm_lang$core$Native_Platform.addPublicModule(Elm['Main'], 'Main', typeof _robot_overlord$robot_overlord$Main$main === 'undefined' ? null : _robot_overlord$robot_overlord$Main$main);
